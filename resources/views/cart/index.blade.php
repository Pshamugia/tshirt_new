                    ...
                    <tbody>
                        @foreach ($cartItems as $item)
                            <tr id="cart-item-{{ $item->id }}">
                                ...
                                <td class="text-center align-middle fw-bold">${{ number_format($item->total_price, 2) }}</td>
                                <td class="text-center align-middle">
                                    <button class="btn btn-sm btn-outline-danger delete-cart-item" data-id="{{ $item->id }}">
